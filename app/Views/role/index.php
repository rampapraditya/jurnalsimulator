<script type="text/javascript">
    ...
    function save() {
        ...
        if (nama === '') {
            alert("Nama hak akses tidak boleh kosong");
        } else {
    ...
    function hapus(id, nama) {
        if (confirm("Apakah anda yakin menghapus hak akses " + nama + " ?")) {
            $.ajax({
    ...
    function ganti(id) {
        ...
        $('#form')[0].reset();
        $('#modal_form').modal('show');
        $('.modal-title').text('Ganti departemen');
        $.ajax({
...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">MASTER DEPARTEMEN</h4>
                    <p class="card-description">Maintenance data departemen</p>
