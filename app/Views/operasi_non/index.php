<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>/oprsimnon/ajaxlist",
            ordering: false
        });
    });
    ...
    function save() {
        ...
        if(document.getElementById('rbPemanasan').checked){
            ...
            var url = "";
            if (save_method === 'add') {
                url = "<?php echo base_url(); ?>/oprsimnon/ajax_add";
            } else {
                url = "<?php echo base_url(); ?>/oprsimnon/ajax_edit";
            }
    ...
    function hapus(id, nama, mode) {
        if (confirm("Apakah anda yakin menghapus opslat nomor " + nama + " ?")) {
            $.ajax({
                url: "<?php echo base_url(); ?>/oprsimnon/hapus/" + id + "/" + mode,
                type: "POST",
                dataType: "JSON",
                success: function (data) {
                    alert(data.status);
    ...
    function ganti(id) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>/oprsimnon/ganti/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
    ...
    function showopsi(){
        ...
        tb_renlat = $('#tb_renlat').DataTable({
            ajax: "<?php echo base_url(); ?>/oprsimnon/ajaxrenlat",
            ordering: false,
            retrieve:true,
            scrollX: true
        });
    ...
    function cetak(){
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>/oprsimnon/load_smulator",
            type: "POST",
            dataType: "JSON",
            success: function (data) {
    ...
    function printcetak(){
        ...
        if(tgl1 === ""){
            ...
            window.location.href = "<?php echo base_url(); ?>/oprsimnon/cetak/" + tgl1 + "/" + tgl2 + "/" + simulator_cetak;
        }
    }
