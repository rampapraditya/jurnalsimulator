<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>/suratmasuknon/ajaxlist",
            ordering: false
        });
    });
    ...
    function gass(){
        ...
        var url = "";
        if (save_method === 'add') {
            url = "<?php echo base_url(); ?>/suratmasuknon/ajax_add";
        } else {
            url = "<?php echo base_url(); ?>/suratmasuknon/ajax_edit";
        }
    ...
    function hapus(id, nama) {
        if (confirm("Apakah anda yakin menghapus surat masuk nomor " + nama + " ?")) {
            $.ajax({
                url: "<?php echo base_url(); ?>/suratmasuknon/hapus/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data) {
                    alert(data.status);
    ...
    function ganti(id) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>/suratmasuknon/ganti/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
    ...
    function showsim(){
        ...
        tbsim = $('#tbsim').DataTable({
            ajax: "<?php echo base_url(); ?>/suratmasuknon/ajaxsim",
            ordering: false,
            retrieve:true,
            scrollX: true
        });
    ...
    function printcetak(){
        ...
        if(tgl1 === ""){
            ...
            window.open("<?php echo base_url(); ?>/suratmasuknon/cetak/" + tgl1 + "/" + tgl2, "_blank");
        }
    }
