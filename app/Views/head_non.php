        ...
        <div class="container-scroller"> 
            <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                    ...
                    <div>
                        <a class="navbar-brand brand-logo" href="<?php echo base_url(); ?>/homenonadmin">
                            <h2>JURNAL</h2>
                        </a>
                        <a class="navbar-brand brand-logo-mini" href="<?php echo base_url(); ?>/homenonadmin">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                                ...
                                <a href="<?php echo base_url(); ?>/profilenon" class="dropdown-item"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i>Profile</a>
                                <a href="<?php echo base_url(); ?>/changepassnon" class="dropdown-item"><i class="dropdown-item-icon mdi mdi-security text-primary me-2"></i>Ganti Password</a>
