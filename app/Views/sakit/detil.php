<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>/sakitsim/ajaxdetil/<?php echo $head->idsakit; ?>",
            ordering: false
        });
    });
    ...
    function save() {
        ...
        if (nama === "") {
            ...
            var url = "";
            if (save_method === 'add') {
                url = "<?php echo base_url(); ?>/sakitsim/ajax_add_detil";
            } else {
                url = "<?php echo base_url(); ?>/sakitsim/ajax_edit_detil";
            }
    ...
    function hapus(id, nama) {
        if (confirm("Apakah anda yakin menghapus barang nomor " + nama + " ?")) {
            $.ajax({
                url: "<?php echo base_url(); ?>/sakitsim/hapusdetil/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data) {
                    alert(data.status);
    ...
    function ganti(id) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>/sakitsim/gantidetil/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
